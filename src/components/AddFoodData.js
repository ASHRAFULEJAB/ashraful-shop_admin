    ...
    <>
      ...
      <div className="food-outermost">
        ...
        <div className="form-outer">
          <h2 className="admin">Admin Pannel For Ashraful Shop</h2>
          ...
          <form className="form-inner">
            ...
            <div className="form-row">
              <div className="form-col">
                <label>Product Identify Number/Name</label>
                <input
                  type="text"
              ...
              <div className="form-col">
                <label>Product Street / Area Name</label>
                <input
                  type="text"
