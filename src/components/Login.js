  ...
  return (
    <div className='mt-6'>
      <div class='flex w-full max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg dark:bg-gray-800 lg:max-w-4xl'>
        <div class='hidden bg-cover lg:block lg:w-1/2' style={{}}></div>
        ...
        <div class='w-full px-6 py-8 md:px-8 lg:w-1/2'>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div class='mt-6'>
              <button class='w-full px-6 py-3 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-purple-800 rounded-lg hover:bg-purple-900 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50'>
                Log In
              </button>
            </div>
          </form>
